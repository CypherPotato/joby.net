...
`System.Timers.Timer` tick, and already have all the necessary properties to have your background task running.
...
The `Joby.Job` object has these defined methods:
...
Or, if you're using `Job.Start<>`, you can stop all running jobs started through it at once with:
